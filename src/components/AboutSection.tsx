      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center">
          ...
          <div className="mb-12 flex justify-center">
            <div className="bg-gray-200 rounded-lg aspect-[5/6] w-full max-w-md h-[400px] border-4 border-gray-300 shadow-lg overflow-hidden flex items-center justify-center">
              <img 
          ...
          <div className="text-lg text-gray-700 space-y-6 max-w-4xl mx-auto text-left">
